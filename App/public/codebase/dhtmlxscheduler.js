...
scheduler.locale = {
    date: {
        month_full: "Enero,Febrero,Marzo,Abril,Mayo,Junio,Julio,Agosto,Septiembre,Octubre,Noviembre,Diciembre".split(","),
        month_short: "Jan,Feb,Mar,Apr,May,Jun,Jul,Aug,Sep,Oct,Nov,Dec".split(","),
        day_full: "Domingo,Lunes,Martes,Miercoles,Jueves,Viernes,Sabado".split(","),
        day_short: "Dom,Lun,Mar,Mie,Jue,Vie,Sab".split(",")
    },
    labels: {
        ...
        confirm_closing: "",
        confirm_deleting: "Evento sera eliminado permamentemente, estas seguro?",
        section_description: "Descripcion",
        section_time: "Periodo",
        full_day: "Full day",
        confirm_recurring: "Do you want to edit the whole set of repeated events?",
        section_recurring: "Repeat event",
        button_recurring: "Enable",
...
scheduler._dp_init = function(a) {
    ...
    this.attachEvent("onEventChanged", function(b) {
        this._loading || a.setUpdated(b, !0, "updated")
    });
